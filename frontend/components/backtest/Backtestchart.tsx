...
import { Card, LoadingSpinner, ErrorToast, Button } from '@/components/ui'
import type { CandleItem, SignalItem, CandlesResponse, SignalsResponse } from '@/types/api.generated'
